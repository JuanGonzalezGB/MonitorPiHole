...
class CrimsonColor(Estilo):
    def __init__(self):     
        ...
        self.ok = "#ff0000"     # good (verde clásico para contraste funcional)
        self.mid = "#ff807b"    # mid (ámbar/naranja suave tipo warning)
        self.bad = "#ffbebe"       # bad (rojo principal del tema)
