...
class TealColor(Estilo):
    def __init__(self):
        ...
        self.colorok = "#2ee6c5"     # good (turquesa vivo pero controlado)
        self.colormid = "#2377c5"    # mid (teal más suave / aqua warning)
        self.colorbad = "#686dc5"       # bad (teal profundo más “serio”)
